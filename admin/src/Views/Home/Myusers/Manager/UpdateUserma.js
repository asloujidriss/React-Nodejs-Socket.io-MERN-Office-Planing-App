                    ...
                    <div className="col-md-12">
                        ...
                        <div className="panel panel-default">
                            <div className="panel-heading">
                                <h3 className="panel-title"><strong>Update</strong> manager</h3>
                                ...
                                <div className="form-group">
                                    ...
                                    <div className="col-md-6 col-xs-12">                                            
                                        <div className="col-1">
                                            ...
                                            <select  className="form-control"  value={data.isManager} name="isManager"  onChange={onChangeHandler}>
